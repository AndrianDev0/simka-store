...
- `analyst` — аналитика, CSV, просмотр промокодов, статус и технические ошибки;
- `marketing` — аналитика, CSV-отчёты и управление промокодами;
- `sales` — заказы, их обработка, клиенты в режиме чтения и общая аналитика;
