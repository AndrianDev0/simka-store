...
export default function Storefront({categories=[],products,customer}:{categories?:PublicCategory[];products:Product[];customer?:CheckoutCustomer}) {
  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <section id="top" className="theme-hero relative overflow-hidden border-b border-[#dce7f4] bg-[#f7fbff]"><div className="absolute inset-0 sim-grid opacity-45"/><div className="relative mx-auto grid max-w-[1240px] items-center gap-8 px-4 py-12 sm:px-6 md:grid-cols-[1.1fr_.9fr] md:py-16"><div>
