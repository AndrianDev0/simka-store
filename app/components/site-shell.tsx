  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <header className="sticky top-0 z-40 border-b border-border/80 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex h-[72px] max-w-[1240px] items-center gap-8 px-4 sm:px-6">
        ...
        <a href="/?checkout=1" className="ml-auto inline-flex min-h-11 items-center gap-2 rounded-xl bg-[#10213a] px-4 text-sm font-bold text-white hover:bg-[#1168e8]">Открыть магазин <ArrowRight className="size-4"/></a>
      </div>
    </header>
