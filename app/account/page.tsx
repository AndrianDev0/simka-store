    ...
    <ContentSection>
      ...
      <div className="grid gap-6 lg:grid-cols-[.8fr_1.2fr]">
        <section className="rounded-2xl border border-[#dbe5ef] bg-white p-6 shadow-[0_12px_35px_rgba(23,58,96,.06)]">
          ...
          <a href={SUPPORT_TELEGRAM_URL} target="_blank" rel="noreferrer" className="mt-5 flex min-h-11 items-center justify-center rounded-xl border border-[#cddbea] bg-[#f8fbfe] p-3 text-center text-sm font-bold text-[#1168e8] transition hover:border-[#9fc5f4] hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1168e8] focus-visible:ring-offset-2">Написать в поддержку · @{SUPPORT_TELEGRAM_USERNAME}</a>
        </section>
