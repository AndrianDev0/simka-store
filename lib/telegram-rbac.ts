...
const allPermissions: TelegramPermission[] = [
  ...
  "customers.export", "customers.delete", "analytics.read", "analytics.export", "settings.read", "settings.write",
...
const permissionsByRole: Record<TelegramRole, ReadonlySet<TelegramPermission>> = {
  ...
  analyst: new Set(["analytics.read", "analytics.export", "operations.read"]),
  marketing: new Set(["analytics.read", "analytics.export"]),
