...
const allowedTables = new Set([
  "partners", "partner_clicks", "customer_accounts", "customer_sessions", "customer_password_resets", "privacy_consent_events", "orders", "order_items", "crypto_payments", "crypto_payment_events",
...
const insertOrder = ["partners", "partner_clicks", "customer_accounts", "privacy_consent_events", "countries", "operators", "categories", "products", "product_variants", "product_images", "product_categories", "orders", "order_items", "crypto_payments", "crypto_payment_events", "customer_sessions", "customer_password_resets", "admin_audit_log", "operational_events", "store_settings", "seo_redirects"];
